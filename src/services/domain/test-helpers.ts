...
export const DOMAIN_ID = "dom_123456789";

export function domainFixture(overrides: Record<string, unknown> = {}) {
	return {
...
export function statusResponseFixture(overrides: Record<string, unknown> = {}) {
	return {
		id: DOMAIN_ID,
