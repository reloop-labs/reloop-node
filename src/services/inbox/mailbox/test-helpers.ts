...
export const MAILBOX_ID = "mbx_123456789";

export function mailboxFixture(overrides: Record<string, unknown> = {}) {
	return {
		id: MAILBOX_ID,
...
export function mailboxDetailFixture(overrides: Record<string, unknown> = {}) {
	return {
		...mailboxFixture(),
...
export function createMailboxResponseFixture(
